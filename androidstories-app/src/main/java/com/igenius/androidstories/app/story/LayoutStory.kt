...
data class LayoutStory(
     ...
     *  and when the user will select a different variant. See {@link com.igenius.androidstories.app.story.StoryFragment#onVariantSelected}
...
data class AsyncLayoutStory<T>(
     ...
     * see {@link com.igenius.androidstories.app.story.AsyncStoryFragment#preventUiLoader}
     */
    val preventUiLoader: Boolean = false,

    /**
     *  Executed when the provider resolve a data for a given variant
     *  see {@link com.igenius.androidstories.app.story.AsyncStoryFragment#onVariantLoaded}
     *  @param this The inflated view
     *  @param variant The selected variant
