...
<p align="center">
 ...
 - [How to use](#how-to-use)
	...
	- [Async stories](#async-stories)
		- [AsyncComposeStory](#asynccomposestory)
...
### ComposeStory
This is an example of a composable story:
a ComposeStory variable that defines the title by the variable name
and the content by a composable function
```kotlin
@Story
val compose_story = ComposeStory {
	Text("Composable story")
}
```
...
Complete usage example of a [LayoutStory](androidstories-app/src/main/java/com/igenius/androidstories/app/story/LayoutStory.kt#L8):
...
### AsyncComposeStory
[AsyncComposeStory](androidstories-app/src/main/java/com/igenius/androidstories/app/story/AsyncComposeStory.kt#L9) is similar to [ComposeStory](androidstories-app/src/main/java/com/igenius/androidstories/app/story/ComposeStory.kt#L5) but with a data parameter to the composable function
